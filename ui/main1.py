...
uifile_0 = os.path.join("start_window.ui"); # Enter file here.
uifile_1 = os.path.join("About.ui"); # Enter file here.
uifile_2 = os.path.join("Help.ui"); # Enter file here.
uifile_3 = os.path.join("input_window.ui"); # Enter file here.
uifile_4 = os.path.join("saaa.ui"); # Enter file here.
